...
На схеме `poster.drawio` нарисованы схема БД и основные компоненты приложения. Доменная область почти полностью совпадает со схемой БД, так что её нет. 

Вариантов использования мало, а ещё они полностью понятны из контекста приложения, так что в схеме они тоже опущены.
